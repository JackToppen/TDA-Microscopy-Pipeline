...
#vectorized_PLs <- cbind(vec_red, vec_green, vec_pos)[1:60,] #pick red, green or all cells
#vectorized_PLs <- cbind(vec_red_1[1:60, 1:4240], vec_red_0[1:60, 1:2870], vec_green_1[1:60, 1:4730], vec_green_0[1:60, 1:5950])
vectorized_PLs <- cbind(vec_red_1[61:120, 1129:3760], vec_green_1[61:120, 1459:4860], vec_pos_1[61:120, 1246:4150], vec_neg_1[61:120, 1378:4590])
#vectorized_PLs <- cbind(rbind(counts[[2]][[1]], counts[[2]][[2]], counts[[2]][[3]], counts[[2]][[4]]))
tic()
nrepeats <- 10000
...
#vectorized_PLs <- cbind(rbind(counts[[1]][[1]], counts[[1]][[2]], counts[[1]][[3]], counts[[1]][[4]]), vec_red[1:60, 5389:18400], vec_green[1:60, 5332:17770], vec_pos[1:60, 5533:18410], vec_neg[1:60,2860:9530])
vectorized_PLs <- cbind(rbind(counts[[1]][[1]], counts[[1]][[2]], counts[[1]][[3]], counts[[1]][[4]]), vec_red[1:60, 1797:26970], vec_green[1:60, 2238:17770], vec_pos[1:60,1454:18410], vec_neg[1:60,1111:9530])
#vectorized_PLs <- cbind(rbind(counts[[2]][[1]], counts[[2]][[2]], counts[[2]][[3]], counts[[2]][[4]]))
...
rand.perm <- sample(n)
vectorized_PLs <- rbind(counts[[2]][[1]], counts[[2]][[2]], counts[[2]][[3]], counts[[2]][[4]])
#vectorized_PLs <- cbind(rbind(vec_red_1[1:30, 1273:42400], vec_red_1[31:60, 1273:42400]), rbind(vec_green_1[1:30, 1420:47300],vec_green_1[31:60, 1420:47300]), rbind(vec_pos_1[1:30,1246:41500],vec_pos_1[31:60,1246:41500]), rbind(vec_neg_1[1:30,1378:13700], vec_neg_1[31:60,1378:13700]))
#vectorized_PLs <- cbind(vec_red_1[61:120, 1273:4240], vec_green_1[61:120, 1420:4730],vec_pos_1[61:120,1246:4150], vec_neg_1[61:120,1378:1370])
...
total_accuracy <- total_accuracy/n
...
vectorized_PLs <- cbind(vec_red_1[1:60, 1273:4240], vec_green_1[1:60, 1420:4730],vec_pos_1[1:60,1246:4150], vec_neg_1[1:60,1378:1370])
#vectorized_PLs <- cbind(rbind(vec_red_1[1:15, 1273:42400], vec_red_1[31:60, 1273:42400]), rbind(vec_green_1[1:15, 1420:47300],vec_green_1[31:60, 1420:47300]), rbind(vec_pos_1[1:15,1246:41500],vec_pos_1[31:60,1246:41500]), rbind(vec_neg_1[1:15,1378:13700], vec_neg_1[31:60,1378:13700]))
...
plot(prediction)
symbols <- c(21:24)
plot(0, col="white", bty="o", xlim=c(1,n), ylim=c(min(prediction), max(prediction)), ylab="estimated dox concentration", xlab="")
for (i in 1:4){
  low_i <- (i-1)*15+1
  high_i <- i*15
