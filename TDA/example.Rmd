...
save_PD_filename <-  "persistence-diagrams.RData" #name of the file
save_PD_file_location <- "~/Documents/GitHub/TDA-Microscopy-Pipeline/" #location where to save the file
...
save_PL_file_location <- "~/Documents/GitHub/TDA-Microscopy-Pipeline/"
