...
cell_types <- all_cell_types[2]   # either a single value or a vector
...
*This is needed to generate all plots with the same scale and make sure that persistence landscapes have the same length*
