...
*Pull generalized functions for processing the segmentation files before running TDA.*
...
csv_path <- "~/Research/TDA/Microscopy_images/Test/Nanog_HA/1"
```
...
# specify directory paths of baseline CSVs for each threshold
gfp_thresh_path <- "~/Research/TDA/Microscopy_images/Test/Nanog_HA/1/25"
rfp_thresh_path <- "~/Research/TDA/Microscopy_images/Test/Nanog_HA/1/0"

# generate respective channel thresholds for discretizing cell intensities
...
disc_path <- "~/Research/TDA/Microscopy_images/Discretized/75/Nanog_HA/1"
...
disc_path <- "~/Research/TDA/Microscopy_images/Discretized/75/Nanog_HA/1"
image_path <- "~/Research/TDA/Microscopy_images/Images/75/Nanog_HA/1"
