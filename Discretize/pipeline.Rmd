  ...
  for (conc in c(0, 25)) {
    for (well in c(1)) {
      for (loc in c(1)) {
        ...
        csv_path <- paste0("Output/",sig,"/",conc,"/",sig,"_",conc,"_",well,"_",loc,"/")
    ...
    for (perc_index in c(1)) {
      ...
      for (dox_index in c(1, 2)) {
        ...
        for (well in c(1)) {
          ...
          disc_path_im <- paste0("Discretized-images/", perc, "/", sig, "/", conc, "/")
          disc_path_csv <- paste0("Discretized-values/", perc, "/", sig, "/", conc, "/")
